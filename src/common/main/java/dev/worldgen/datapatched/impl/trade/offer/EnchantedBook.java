...
public record EnchantedBook(Optional<ItemCost> buyingSecondary, HolderSet<Enchantment> enchantments, int minLevel, int maxLevel, int maxUses, int experience, float priceMultiplier) implements SimpleTradeOffer {
    public static final MapCodec<EnchantedBook> CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(BUYING_CODEC.optionalFieldOf("buying_secondary").forGetter(EnchantedBook::buyingSecondary), RegistryCodecs.homogeneousList(Registries.ENCHANTMENT).fieldOf("enchantments").forGetter(EnchantedBook::enchantments), Codec.intRange(1, 255).fieldOf("min_level").orElse(1).forGetter(EnchantedBook::minLevel), Codec.intRange(1, 255).fieldOf("max_level").orElse(255).forGetter(EnchantedBook::maxLevel), Codec.INT.fieldOf("max_uses").orElse(12).forGetter(EnchantedBook::maxUses), Codec.INT.fieldOf("experience").orElse(1).forGetter(EnchantedBook::experience), Codec.FLOAT.fieldOf("price_multiplier").orElse(0.2F).forGetter(EnchantedBook::priceMultiplier)).apply(instance, EnchantedBook::new));

    public EnchantedBook(Optional<ItemCost> buyingSecondary, HolderSet<Enchantment> enchantments, int minLevel, int maxLevel, int maxUses, int experience, float priceMultiplier) {
