...
public class ReloadableServerRegistriesMixin {
    ...
    private static WritableRegistry<?> applyLootModifiers(
        ...
        Optional<HolderGetter<LootModifier>> getter = ops.getter(LootpatchedRegistries.LOOT_MODIFIER);
        if (getter.isPresent() && getter.get() instanceof HolderLookup<LootModifier> lookup) {
            ...
            Lootpatched.LOGGER.error("Couldn't get loot modifier registry, not applying loot modifiers :(");
        }
        return registry;
    }
}
